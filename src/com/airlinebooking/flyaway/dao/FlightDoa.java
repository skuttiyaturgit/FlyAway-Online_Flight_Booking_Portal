...
public class FlightDoa {
	...
	public Flight createRoute(Flight flight) {
		try {
			...
			PreparedStatement preparedStatement = connection
					.prepareStatement("insert into tflight(name,rate) values(?,?)");
	...
	public Flight createFlight(Flight flight) {
		try {
			Connection connection = DataBaseConnection.getConnection();
			PreparedStatement preparedStatement = connection
					.prepareStatement("insert into tflight(name,rate,route_id) values(?,?,?)");
	...
	public ResultSet getFlightDetails(Integer sourceId) {
		...
		try {
			...
			preparedStatement = connection
					.prepareStatement("select * from  tflight where route_id=?");
